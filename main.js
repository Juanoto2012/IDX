...
function getAppResourcesPath() {
  ...
  return path.join(app.getAppPath(), '..', '..', 'resources', 'app');
}

function startLocalServer() {
  return new Promise((resolve, reject) => {
    baseDir = getAppResourcesPath();
...
async function createWindow() {
  ...
  const splash = new BrowserWindow({
    ...
    frame: false,
    alwaysOnTop: true,
    icon: path.join(getAppResourcesPath(), 'assets/logo.ico')
  });
  ...
  const win = new BrowserWindow({
    ...
    icon: path.join(getAppResourcesPath(), 'assets/logo.ico'),
    webPreferences: {
      preload: path.join(getAppResourcesPath(), 'preload.js'),
